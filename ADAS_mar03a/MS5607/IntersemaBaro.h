...
private:
    ...
    virtual int32_t AcquireAveragedSampleCm(const uint8_t nSamples)
    {
        ...
        {
            const uint32_t temperature = ReadAdc(cmdAdcD2_ | cmdAdc256_); // digital temperature value : typical 8077636  
            const uint32_t pressure    = ReadAdc(cmdAdcD1_ | cmdAdc256_); // digital pressure value : typical 6465444        
